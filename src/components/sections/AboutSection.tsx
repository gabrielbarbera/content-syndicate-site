...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Navigate and manage your press release submissions effortlessly with our intuitive and user-friendly interface, saving you time and effort.",
  },
  {
    icon: BarChart3,
    title: "Comprehensive Analytics",
    description:
      "Gain valuable insights into the performance of your press releases with our comprehensive analytics reporting, helping you measure engagement.",
  },
  {
    icon: Headphones,
...
export default function AboutSection() {
  return (
    <>
      {/* Who We Are */}
      <section className="relative overflow-hidden border-y border-zinc-200 bg-white py-24 lg:py-32">
              ...
              >
                <div className="relative h-full rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all duration-500 hover:border-accent/50 hover:bg-white/10 overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-200 leading-relaxed group-hover:text-gray-300 transition-colors">
                      {feature.description}
                    </p>
                  </div>
                </div>
